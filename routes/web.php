...
Route::get('/transaksi', [BookingController::class, 'transaksi'])->name('transaksi');
Route::get('/review/{id}', [BookingController::class, 'review'])->name('review');
Route::post('/review_action', [BookingController::class, 'review_action'])->name('review_action');
Route::get('/transaksi/{id}', [BookingController::class, 'transaksi_detail'])->name('transaksi_detail');
Route::get('/transaksi/bank/{id}', [BookingController::class, 'transaksi_detail_bank'])->name('transaksi_detail_bank');
Route::post('/payment', [BookingController::class, 'payment'])->name('payment');
Route::get('/kirimbukti/{id}', [BookingController::class, 'transfer_bank'])->name('transfer_bank');
Route::post('/kirimbukti', [BookingController::class, 'kirimbukti'])->name('kirimbukti');

Route::post('/payment/stripe/{price}', [BookingController::class, 'stripe'])->name('stripe');
Route::post('/payment/midtrans/callback', [BookingController::class, 'callback'])->name('callback');
...
Route::group(['middleware' => ['admin:admin']], function () {
    ...
    Route::post('/admin/order/invoice/update', [AdminOrderController::class, 'invoice_update'])->name('admin_invoice_update');
