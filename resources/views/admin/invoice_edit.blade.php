...
@section('heading', 'Reservation Invoice')
            ...
            <div class="invoice-print">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="invoice-title">
                            <h2>Invoice</h2>
                            <div class="invoice-number">Reservation #{{ $order->order_no }}
                                @if ($order->status == 'Pending')
                                    <span class="badge badge-warning">Reservation Status Pending</span>
                                @elseif($order->status == 'Completed')
                                    <span class="badge badge-success">Reservation Status Completed</span>
                                @elseif($order->status == 'Cancel')
                                    <span class="badge badge-danger">Reservation Status Batal</span>
                                @endif
                            </div>
                        </div>
                        <hr>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <p class="section-lead">Bungalow room information are given below in detail:</p>
